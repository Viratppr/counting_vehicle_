...
while True:
    ...
    cv2.line(frame1,(25,count_line_postion),(1200,count_line_postion))
    ...
    for (i,c) in enumerate(countershape):
        ...
        cv2.circle(frame1,center,center,4,(0,0,255),-1)
    ...
    cv2.line(frame1,"VECHILE COUNTER :"+str (25,counter),(450,70),cv2.FONT_HERSHEY_SIMPLEX,2,(0,0,255),5)
